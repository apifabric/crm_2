...
def expose_models(api, method_decorators = []): 
    ...
    api.expose_object(database.models.CampaignLead, method_decorators= method_decorators)
    api.expose_object(database.models.Lead, method_decorators= method_decorators)
